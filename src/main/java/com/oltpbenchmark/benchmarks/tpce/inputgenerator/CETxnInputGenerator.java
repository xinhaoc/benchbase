package com.oltpbenchmark.benchmarks.tpce.inputgenerator;
...
import com.oltpbenchmark.benchmarks.tpce.tablegenerator.StatusTypeGenerator.StatusTypeId;
...
public class CETxnInputGenerator {
    ...
    public CETxnInputGenerator(TPCEGenerator inputFiles, long configuredCustomerCount, long activeCustomerCount,
        ...
        person = new PersonHandler(inputFiles.getInputFile(TPCEGenerator.InputFile.LNAME), inputFiles.getInputFile(TPCEGenerator.InputFile.FEMFNAME), inputFiles.getInputFile(InputFile.MALEFNAME));
        ...
        accountPerms = (AccountPermsGenerator) inputFiles.getTableGen(TPCEConstants.TABLENAME_ACCOUNT_PERMISSION);
        holdings = new HoldingsAndTrades(inputFiles);
        brokers = (BrokerGenerator) inputFiles.getTableGen(TPCEConstants.TABLENAME_BROKER);
