...
public class TTradeOrderTxnInput {
    ...
    public int getIsLifo() {
        return is_lifo;
    }

    public int getRollItBack() {
        return roll_it_back;
    }
    ...
    public void setIsLifo(int is_lifo) {
        this.is_lifo = is_lifo;
    }

    public void setRollItBack(int roll_it_back) {
    ...
    public void setTypeIsMargin(int type_is_margin) {
    ...
    private int is_lifo;
    private int roll_it_back;
    private int trade_qty;
    private int type_is_margin;
