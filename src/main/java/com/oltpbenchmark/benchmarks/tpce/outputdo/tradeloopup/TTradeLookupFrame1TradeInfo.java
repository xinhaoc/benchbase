...
public class TTradeLookupFrame1TradeInfo {
    ...
    public TTradeLookupFrame1TradeInfo() {
        ...
        for (int i = 0; i < TradeLookupMaxTradeHistoryRowsReturned; i++) trade_history_status_id[i] = new String();
    ...
    public int getIs_market_ind() {
        return is_market_ind;
    }

    public void setIs_market_ind(int is_market_ind) {
        this.is_market_ind = is_market_ind;
    }
