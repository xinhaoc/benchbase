...
public class TTradeUpdateFrame3TradeInfo {
    ...
    public TTradeUpdateFrame3TradeInfo() {
    ...
    public int getS_name_ind() {
        return s_name_ind;
    }

    public void setS_name_ind(int s_name_ind) {
        this.s_name_ind = s_name_ind;
    }
    ...
    public int getType_name_ind() {
        return type_name_ind;
    }

    public void setType_name_ind(int type_name_ind) {
        this.type_name_ind = type_name_ind;
    }
}
